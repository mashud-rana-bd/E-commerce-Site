...
<div class="banner1">
			<div class="container">
				<h3><a href="index-2.html">Home</a> / <span>Products</span></h3>
			</div>
		</div>
	<!--banner-->
		<!--content-->
			<div class="content">
				<!---728x90--->
<script src='{{asset('front-end/publisher.eboundservices.com/dynamicAds/dynamicScript.js')}}'></script>
								...
								<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
									...
									<div id="myTabContent" class="tab-content">
										<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
											...
											@foreach ($barndproducnts as $barndproducnt)

												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{asset($barndproducnt->product_image)}}" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{asset($barndproducnt->product_image)}}" class="img-responsive"  alt="">
														...
														<div class="women">
															<h6><a href="single.html">{{ $barndproducnt->product_name }}</a></h6>
															<span class="size">XL / XXL / S </span>
															<p ><em class="item_price">Tk.{{ $barndproducnt->product_prize }}</em></p>
											...
											<div class="product-tab1">
												...
												<div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
													...
													<div class="women">
														<h6><a href="single.html">{{ $barndproducnt->product_name }}</a></h6>
														<span class="size">XL / XXL / S </span>
														<p>{{ $barndproducnt->short_description}}</p>
														<p ><em class="item_price">Tk.{{$barndproducnt->product_prize  }}</em></p>
														<a href="#" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
													</div>
												</div>
