...
<div class="banner1">
			<div class="container">
				<h3><a href="index-2.html">Home</a> / <span>Single</span></h3>
			</div>
		</div>
	<!--banner-->
						...
						<div class="col-md-9 single-grid">
							<div clas="single-top">
								...
								<div class="single-right simpleCart_shelfItem">
									...
									<p class="price item_price">Tk.{{ $singleproduct->product_prize  }}</p>
									<div class="description">
										<p><span>Quick Overview : </span> {{$singleproduct->long_description  }}</p>
									</div>
