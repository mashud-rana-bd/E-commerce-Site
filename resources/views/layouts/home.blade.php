...
<head>
  ...
  <script src="{{asset('admin/sample.js')}}"></script>
  <link rel="stylesheet" href="{{asset('admin/samples.css')}}">
  <link rel="stylesheet" href="{{asset('admin/neo.css')}}">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('managecategory')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Mangae Category</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('showallbrand')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Mangae Brand</p>
                </a>
              </li>
